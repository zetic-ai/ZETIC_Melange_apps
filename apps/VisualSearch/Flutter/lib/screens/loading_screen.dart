...
/// embedder) and the bundled catalog loads + warms up. Owns the
/// [MelangeService] and hands it to the main screen once ready.
            ...
            children: [
              ScaleTransition(
                ...
                child: const Icon(Icons.center_focus_strong,
                    color: SnapColors.accent, size: 96),
              ),
              ...
              Text('On-device visual product search',
                  style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text('Could not load the models',
            style: TextStyle(
                color: Colors.white,
                fontSize: 16,
