...
| **Mental Wellness** | [**Counsel Companion**](apps/CounselCompanion) | On-device AI counseling companion with multi-session management, customizable persona, and privacy-first design. | [**View**](https://mlange.zetic.ai/p/Steve/kanana_1_5__2_1b_instruct) |
